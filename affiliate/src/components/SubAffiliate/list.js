...
// getdataSubAffiliate
  ...
  const getAllUser = () => {
    fetch("/api/agent/getdataSubAffiliate", {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  function getPaginatedUsers() {
    fetch(
      `/api/agent/paginatedSubAffiliate?page=${currentPage.current}&limit=${limit}`,
      {
        method: "GET",
      }
    )
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title"> Sub Affiliate List </h4>

                <Link to="/subsffiliate-create">
                                ...
                                <td>
                                  <div className="d-flex">
                                    <Link
                                      ...
                                      to={`/editSubAffiliate/${element.usAutoId}`}
                                      // to={`edit-agent/11`}
                                    >
...
export default SubAffiliateList;
