...
const SubAffiliateEdit = ({usAutoId}) => {
   ...
   useEffect(() => {
    ...
    const fetchUser = async () => {
      try {
        ...
        const response = await axios.get(`/api/agent/editSubAffiliate/11`);
  ...
  const addinpdata = async (e) => {
    ...
    // const res = await fetch(`/api/agent/update-agent/${usAutoId}`, {
      method: "POST",
      headers: {
          ...
          <div class=" col-lg-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Sub Affiliate Edit | Id: {userId}</h4>
...
export default SubAffiliateEdit;