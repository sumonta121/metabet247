                ...
                <div className="right-site-menu">
                    ...
                    <div className="right-wrapper-area">
                        ...
                        <div className="betslip-wrapper">
                            <Link to="#0" className="left-betslip">
                        ...
                        <div className="combo-box">
                            <ul className="nav">
                                ...
                                <Link className="nav-link link-secondary" data-bs-toggle="tab" data-bs-target="#coombomobile" to="#"><span>Single bets</span>
                                </Link>
                                </li>
                                <li className="nav-item">
                                <Link className="nav-link link-secondary active" data-bs-toggle="tab" data-bs-target="#bbetsmobile" to="#"><span>Combo</span></Link>
                                </li>
                            </ul>
                            ...
                            <div className="accordion" id="accordionExamplemy">
                                ...
                                <div className="accordion-header" id="headingThree03">
                                    ...
                                    <div className="accordion-body">
                                        <Link to="#0" className="condition-box">
                                            Terms & Conditions
                                        </Link>
