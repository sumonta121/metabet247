        ...
        <div className="modal-content">
            <div className="modal-header">
                <div className="head">  
                    ...
                    <p>Already have an account? <Link to="#0" className="text-base">Login</Link></p>
                </div>
            </div>
                    ...
                    <div className="items">
                        <div className="check-area">
                            ...
                            <div className="form-check">
                                ...
                                I agree to the <Link to="#0" className="text-base">Privacy Policy</Link>
                                </label>
                            </div>
                            <div className="form-check">
                                <input className="form-check-input" type="checkbox" value="" id="ones3" />
                                <label className="form-check-label" for="ones3">
                                I want to receive <Link to="#0" className="text-base">news and offers</Link>
                                </label>
                            </div>
                        </div>
                    </div>
