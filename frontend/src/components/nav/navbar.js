      ...
      if (this.props.loggedIn) {
        return (
          <div>
            <nav className="nav-bar-container">
                <Link className="logo" to={'/main'}><img src="https://placehold.co/220x80?text=XYZ+GAME"></img></Link>
               
                <button className="profile-btn"  style={{background:'#271F25'}} > <Link  to={'/'}>Home</Link></button>
                ...
                <button className="profile-btn"  style={{background:'#271F25'}} ><Link to={'/profile'}  style={{fontSize:'16px'}}>User Name: {this.props.user.handle}</Link></button>
        ...
        return (
            <nav className="nav-bar-container">
                ...
                <Link className="signup-btn" to={'/'}>Home</Link>
