...
const List = () => {
  ...
  function getPaginatedUsers() {
    fetch(
      `${apiConfig.baseURL}/api/agent/pending_withdraw_request?page=${currentPage.current}&limit=${limit}&user_id=${user_id}`,
      {
        method: "GET",
      }
    )
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">User Pending Withdraw Request</h4>
                                ...
                                <tr key={index}>
                                    ...
                                    <td>
                                        ...
                                        <button
                                          ...
                                          onClick={() => handleApprovePayment(withdraw._id,'Paid')} // Call approvePayment with ID
                                         >
                                        ...
                                        <button
                                          ...
                                          onClick={() => handleApprovePayment(withdraw._id,'Reject')} // Call approvePayment with ID
                                         >
