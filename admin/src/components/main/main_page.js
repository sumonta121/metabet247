        ...
        <div id="main-wrapper">
          ...
          <div className="nav-header">
            <a href="index.html" className="brand-logo">
              ...
              />
              <img
                src="assets/images/logo/logo-text-color.png"
                className="brand-title color-title"
                alt=""
              />
            </a>
              ...
              <div className="hamburger">
                ...
                >
                  <rect
                    ...
                    fill="#2A353A"
                  />
                  <rect x="11" style={{ width: "4", height: "4" }} rx="2" fill="#2A353A" />
                  <rect x="22" style={{ width: "4", height: "4" }} rx="2" fill="#2A353A" />
                  <rect
                    x="11"
                    y="11"
                    style={{ width: "4", height: "4" }}
                  ...
                  <rect
                    ...
                    fill="#2A353A"
                  />
                  <rect style={{ width: "4", height: "4" }} rx="2" fill="#2A353A" />
                  <rect y="11" style={{ width: "4", height: "4" }} rx="2" fill="#2A353A" />
                  <rect
                    x="22"
                    y="22"
                    style={{ width: "4", height: "4" }}
                    ...
                    fill="#2A353A"
                  />
                  <rect y="22" style={{ width: "4", height: "4" }} rx="2" fill="#2A353A" />
                </svg>
              </div>
            </div>
          </div>
              ...
              <ul className="metismenu" id="menu">
                <li>
                  ...
                  <ul aria-expanded="false">
                    ...
                    <li>
                      <a href="index-1.html">Dashboard-2</a>
                    </li>
                    <li>
                                  ...
                                  <div className="progress-box">
                                    <div className="progress">
                                      <div
                                        ...
                                        style={{width:'50%', height:'7px', borderRadius:'4px' }}
                                        role="progressbar"
                                      ></div>
                                    </div>
                                  </div>
                    ...
                    <div className="col-xl-5 assets-al col-lg-12">
                      <div className="card">
                        ...
                        <div className="card-body text-center pt-0 pb-2">
                          <div id="morris_donught" className="custome-donut"></div>
          ...
          <div className="footer out-footer">
            <div className="copyright">
               <p>Copyright © XYZ-Game by <a href="" target="_blank">SAWEBSOFT</a> 2022</p>
            </div>
          </div>
